...
public class ChannelFetchService extends IntentService
{
    public static final String TAG = ChannelFetchService.class.getSimpleName();

    public ChannelFetchService()
    {
        super(TAG);
    }
